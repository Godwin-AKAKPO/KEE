    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-between px-5 py-16">
        ...
        <motion.h1
          ...
          className="serif text-glow-rose max-w-3xl text-center text-2xl font-light leading-snug text-pearl sm:text-4xl md:text-6xl"
        >
          {text}
          {!textComplete && <span className="ml-1 inline-block h-[1em] w-[2px] animate-pulse bg-gold align-middle" />}
        </motion.h1>
        <div className="flex-1" />
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="animate-pulse-glow rounded-full border border-gold/60 bg-rose-fuchsia/30 px-10 py-4 font-sans text-sm tracking-[0.3em] text-pearl backdrop-blur-md"
        >
          Vas-y 💖
        </motion.button>
      </div>
